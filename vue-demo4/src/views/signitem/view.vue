    ...
    <div class="baby-bg">
        <section class="view-box">
            ...
            <div class="view-box--ctn" v-show="baseInfo.birthPlace">
                ...
                <span class="view-box-val">{{baseInfo.birthPlace}}</span>
            </div>
            ...
            <div class="view-box--ctn" v-show="baseInfo.passportTerm1">
                ...
                <span class="view-box-val">{{baseInfo.passportTerm1}}至{{baseInfo.passportTerm12}}</span>
            </div>
            <div class="view-box--ctn" v-show="baseInfo.passportAddr">
                <span class="view-box--key">护照签发地:</span>
                <span class="view-box-val">{{baseInfo.passportAddr}}</span>
            </div>
            ...
            <div class="view-box--ctn">
                ...
                <span class="view-box-val">{{baseInfo.addr}}</span>
            </div>
            <div class="view-box--ctn">
        ...
        <section class="view-box">
            ...
            <div class="view-box--ctn">
                ...
                <span class="view-box-val">{{agent.companyAddr}}</span>
            </div>
            <div class="view-box--ctn">
                <span class="view-box--key">邮编:</span>
