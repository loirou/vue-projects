<template>
	<div class="form_box info_form">
		...
		<section class="form_box--item">
			...
			<div class="form_box--field">
				<input style="position:reavtive;bottom:4px;" v-model.trim="baseInfo.passportTerm1" class="form_box--input_l input-left" type="date" autocomplete="off" name="passportTerm1">
				<span class="gray_txt input-middle">至</span>
				<input style="position:reavtive;bottom:4px;" v-model.trim="baseInfo.passportTerm2" class="form_box--input_l input-right" type="date" autocomplete="off" name="passportTerm2">
			</div>
		</section>
		<section class="form_box--item">
		...
		<section class="form_box--item">
			<label class="form_box--head">证件号码</label>
		...
		<section class="form_box--item">
			...
			<div class="form_box--field">
				<input style="position:reavtive;bottom:4px;" v-model.trim="baseInfo.visaTerm1" class="form_box--input_l input-left" type="date" autocomplete="off" name="visaTerm1">
				<span class="gray_txt input-middle">至</span>
				<input style="position:reavtive;bottom:4px;" v-model.trim="baseInfo.visaTerm2" class="form_box--input_l input-right" type="date" autocomplete="off" name="visaTerm2">
			</div>
		</section>
		<section class="form_box--item">
		...
		<section class="form_box--item">
			...
			<input v-model.trim="baseInfo.mobile" v-input class="form_box--field form_box--input" type="tel" autocomplete="off" required
				name="mobile">
		</section>
		<section class="form_box--item">
